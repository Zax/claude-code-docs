...
1. [Setup Claude Code](docs/setup.md) — Installazione, autenticazione, integrazione IDE
2. [CLAUDE.md - Memoria di Progetto](docs/claude-md.md) — Il file di contesto persistente
3. [Prompting](docs/prompting.md) — Best practice per prompt efficaci
4. [Modelli Claude](docs/modelli.md) — Overview modelli, casi d'uso, funzionalità
5. [Claude API](docs/api.md) — Extended thinking, ottimizzazione contesto, parametri API
6. [MCP - Model Context Protocol](docs/mcp.md) — Connessione a servizi esterni
7. [Limiti e Pricing](docs/limiti-e-pricing.md) — Piani, costi, rate limit
8. [Tips & Tricks](docs/tips-e-tricks.md) — Consigli pratici per l'uso quotidiano
9. [Link Utili](docs/link-utili.md) — Risorse e riferimenti esterni
10. [Stato del Servizio](docs/status.md) — Monitoraggio uptime e incident
11. [Plugin](docs/plugin.md) — Plugin per estendere Claude Code
12. [Skill](docs/skills.md) — Istruzioni modulari per estendere Claude Code
